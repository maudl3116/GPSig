from models import train_gpsig_vosf_regressor
...
for i in range(num_experiments):
    for dataset in datasets:
        ...
        train_gpsig_vosf_regressor(dataset, inf = True, sig_precompute=False, order = 0, M=500, max_len=500, num_lags=1, fast_algo=False,
                               val_split=0.2, normalize_data=False, normalize_output=True, experiment_idx=i, save_dir=results_dir)    
