...
def train_sigGPDE_classifier(dataset, inf = True, sig_precompute=True, compute_and_diff_sig=False, compute_sig = False, num_levels=5, M=500, normalize_data=True, minibatch_size=50, max_len=500,
